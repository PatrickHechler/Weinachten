...
//class KlasseTest {
//
//	private ModifilableKlasse modifilableKlasse;
//
...
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(fuenferKlasse.getBytes()));
//	}
//
//	@AfterEach
//	void tearDown() throws Exception {
//		modifilableKlasse = null;
//	}
//
//	@Test
//	void testLade() {
//		// test initial klasse
//		assertEquals(fuenferKlasse, modifilableKlasse.toString());
//		
//		// test with space insted of line breaks
//		String modKlass = fuenferKlasse.replace("\n", " ");
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(modKlass.getBytes()));
//		assertEquals(fuenferKlasse, modifilableKlasse.toString());
//
...
//			modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(errKlass.getBytes()));
//		});
//
//		// additional data is ignored
//		final String tooBigKlass = modKlass+"\n1 2 3";
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(tooBigKlass.getBytes()));
//		assertEquals(fuenferKlasse, modifilableKlasse.toString());
//
//		// invalid ids are ignored
//		final String wrongIDsKlass = "1\n99 99 99\n";
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(wrongIDsKlass.getBytes()));
//		assertEquals(wrongIDsKlass, modifilableKlasse.toString());
//		
//	}
//
//	@Test
//	void testSize() {
//		assertEquals(5,  modifilableKlasse.size());
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(sechserKlasse.getBytes()));
//		assertEquals(6,  modifilableKlasse.size());
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(viererKlasse.getBytes()));
//		assertEquals(4,  modifilableKlasse.size());
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(dreierKlasse.getBytes()));
//		assertEquals(3,  modifilableKlasse.size());
//	}
//
//	@Test
//	void testTeilnehmer() {
//		Teilnehmer teilnehmer = modifilableKlasse.teilnehmer(1);
//		assertEquals("T[#1:1,2,3]", teilnehmer.toString());
//		teilnehmer = modifilableKlasse.teilnehmer(2);
//		assertEquals("T[#2:2,4,3]", teilnehmer.toString());
//		teilnehmer = modifilableKlasse.teilnehmer(5);
//		assertEquals("T[#5:5,2,1]", teilnehmer.toString());
//		assertThrows(ArrayIndexOutOfBoundsException.class, () -> modifilableKlasse.teilnehmer(6));
//		assertThrows(ArrayIndexOutOfBoundsException.class, () -> modifilableKlasse.teilnehmer(0));
//	}
//
//	@Test
//	void testEinzelnErstWunsch() {
//		Set<Integer> erstWuensche = modifilableKlasse.einzelnErstWunsch();
//		assertEquals(1, erstWuensche.size());
//		assertTrue(erstWuensche.contains(2));
//		
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(sechserKlasse.getBytes()));
//		erstWuensche = modifilableKlasse.einzelnErstWunsch();
...
//		Set<Integer> zweitWuensche = modifilableKlasse.einzelnZweitWunsch();
//		assertEquals(1, zweitWuensche.size());
//		assertTrue(zweitWuensche.contains(3));
//		
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(sechserKlasse.getBytes()));
//		zweitWuensche = modifilableKlasse.einzelnZweitWunsch();
...
//		Set<Integer> drittWuensche = modifilableKlasse.einzelnDrittWunsch();
//		assertEquals(1, drittWuensche.size());
//		assertTrue(drittWuensche.contains(1));
//
//		modifilableKlasse = ModifilableKlasse.lade(new ByteArrayInputStream(sechserKlasse.getBytes()));
//		drittWuensche = modifilableKlasse.einzelnDrittWunsch();

...
public interface KlasseInterface extends Iterable <Teilnehmer> {
	
	/**
	 * Gibt die Anzahl an {@link Teilnehmer}n dieser {@link KlasseInterface} zurück.
	 * 
	 * @return Anzahl der {@link Teilnehmer} dieser {@link KlasseInterface}
	 */
	int size();
	...
	/**
	 * Bewertet die {@link Verteilung} {@code verteilung} mit allen {@link Teilnehmer}n der {@link KlasseInterface}
	 * 
	 * @param verteilung
